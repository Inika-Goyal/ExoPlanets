        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="flex items-start gap-4 mb-4">
              ...
              <h3 className="text-xl font-bold text-gray-900 mt-2">Revealing the Cosmic</h3>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="flex items-start gap-4 mb-4">
              ...
              <h3 className="text-xl font-bold text-gray-900 mt-2">Exploring the Stars</h3>
            </div>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="flex items-start gap-4 mb-4">
              ...
              <h3 className="text-xl font-bold text-gray-900 mt-2">Uncovering the Celestial</h3>
            </div>
            <p className="text-gray-600 leading-relaxed">
