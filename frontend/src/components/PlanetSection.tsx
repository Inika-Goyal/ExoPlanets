        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-300 mb-8 leading-relaxed">
              Look through the database to find exoplanets
            </p>
                ...
                <div className="bg-slate-900/95 text-white rounded-lg p-4 max-h-80 overflow-y-auto shadow-2xl w-full md:w-80 flex flex-col gap-3">
                  ...
                  {planetNames.length === 0 ? (
                    ...
                    planetNames.map((name, i) => {
                      const row = rows.find(
                        (r) => String(r[displayKey || 'planet_name']) === name
                      );
                      return (
                        <Button
                          key={i}
            ...
            {showFilters && showTable && (
              <div className="mt-6 bg-slate-800/95 text-white p-4 rounded-lg shadow-2xl max-w-md">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div>
                    <label className="block text-gray-300 mb-1">
                      Weight Temp: {weightTemp.toFixed(2)}
                    </label>
                    <input
                      type="range"
                      min={0}
                  ...
                  <div>
                    <label className="block text-gray-300 mb-1">
                      Weight Period: {weightPeriod.toFixed(2)}
                    </label>
                    <input
                      type="range"
                      min={0}
                  ...
                  <div>
                    <label className="block text-gray-300 mb-1">
                      Weight Radius: {weightRadius.toFixed(2)}
                    </label>
                    <input
                      type="range"
                      min={0}
