          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-1">Observing Our Planet from Above</h3>
                  <p className="text-gray-400">Gain a new appreciation for Earth</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-[#d4a855] flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-1">Protecting Our Home</h3>
                  <p className="text-gray-400">Understanding climate and ecosystems</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-[#d4a855] flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-1">Inspiring Future Generations</h3>
                  <p className="text-gray-400">Encouraging exploration and discovery</p>
                </div>
              </div>
            </div>
          </div>
